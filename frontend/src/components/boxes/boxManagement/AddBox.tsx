...
import { boxesList, updateBox } from '../boxesSlice/BoxesSlice';
...
const AddBox = () => {
  ...
  const AddClicked = () => {
    dispatch(updateBox([...list, { id: '1', name: name, address: { addressLine1: address, addressLine2: co, city: city, postalCode: postalCode }, status: 'Free' }]));
    handleClose();
  };
